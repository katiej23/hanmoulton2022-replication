...
const experimentStimuli = [
  ...
  //   // target_word: "rest",
  //   question: "This is a comprehension question!",
  //   correct_answer: "No"
  // },
  // {
  //   item: 1,
  //   condition: "generic_they",
  //   sentence: "Just one grandchild could inherit the jewelry. TBD stimuli for this sentence.",
  //   // target_word: "rest",
  //   question: "This is a comprehension question!",
  //   correct_answer: "No"
  // },
  ...
  // {
  //   item: 1,
  //   condition: "quantificational_him",
  ...
  //   item: 1,
  //   condition: "generic_they",
  //   sentence: "Only one competitor could win the race. TBD stimuli for this sentence.",
  //   // target_word: "rest",
  //   question: "This is a comprehension question!",
  //   correct_answer: "No"
  // },
  ...
  //   item: 1,
  //   condition: "named_they",
  //   sentence: "Only one competitor could win the race. Morgan that the one who would win the race would be them when the times were finally announced.",
  //   // target_word: "rest",
  //   question: "This is a comprehension question!",
  //   correct_answer: "No"
  // },
  ...
  //   item: 1,
  //   condition: "named_him",
  //   sentence: "Only one competitor could win the race. Morgan that the one who would win the race would be him when the times were finally announced.",
  //   // target_word: "rest",
  //   question: "This is a comprehension question!",
  //   correct_answer: "No"
  // },
